...
<html lang="es">
    ...
    <body style="background: rgb(118,21,63); background: linear-gradient(70deg, rgba(118,21,63,1) 3%, rgba(255,211,75,1) 54%, rgba(249,255,68,1) 86%); height: 150vh;">
        <nav class="navbar navbar-expand-lg py-3 navbar-dark bg-dark shadow-sm menu-fixed">
            <div class="container " style="bottom: 20px; margin-top: 5%">
                <a href="#" class="navbar-brand">
                    <!-- Logo Image -->
                    <img src="img/log.png" width="55" alt="" class="d-inline-block align-middle mr-2">
                    <!-- Logo Text -->
        ...
        <div class="container" style="background: bottom;">
            <h1 style="color: black;font-size: 35px; font-weight: bold;">Ventas</h1>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th class="txt">FECHA VENTA</th>
                    <th class="txt">NOMBRE DEL CLIENTE</th>                    
                    <th class="txt"></th>
                    <th class="txt"></th>
                    <th class="txt"></th>
                </tr>
                <c:forEach var="item" items="${ventas}">                   
                    <tr>
                        ...
                        <td>
                            <a href="VentaControlador?action=edit&nro_factura=${item.nro_factura}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="Detalle_ventaControlador?action=view&nro_factura=${item.nro_factura}">
                                <i class="fa-solid fa-file-signature"></i>
                            </a>
                        </td>
                        <td>
                            <a href="VentaControlador?action=total&nro_factura=${item.nro_factura}")">
