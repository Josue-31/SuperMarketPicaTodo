...
<html lang="es">
    ...
    <body style=" background: rgb(68,255,247); background: linear-gradient(50deg, rgba(68,255,247,0.30085959885386815) 0%, rgba(29,145,212,0.8166189111747851) 91%);height: 150vh;">
        ...
        <div class="container" style="background: bottom;">
            <h1 style="color: black;font-size: 35px; font-weight: bold;">Gestion de Productos</h1>
            ...
            <table class="table table-striped">
                <tr>
                    <th class="txt">COD PRODUCTO</th>
                    <th class="txt">NOMBRE PRODUCTO</th>                                                   
                    <th class="txt">STOCK</th>
                    <th class="txt">TIPO</th>                    
                    <th class="txt">FECHA VENCIMIENTO</th>
                    <th class="txt">FECHA ELABORACION</th>
                    <th class="txt">NOMBRE PERSONAL</th>
                ...
                <c:forEach var="item" items="${producto}">                   
                    <tr>
                        ...
                        <td>${item.estado}</td>
                        <td>
                            <a href="ProductoControlador?action=edit&cod_producto=${item.cod_producto}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="ProductoControlador?action=delete&cod_producto=${item.cod_producto}" onclick="return(confirm('DESEA ELIMINAR?'))">
